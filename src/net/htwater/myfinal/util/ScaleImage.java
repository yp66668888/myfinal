...
public class ScaleImage {
	...
	private Logger logger = Logger.getLogger(ScaleImage.class.getName());
	...
	public static void main(String[] args) {
		...
		try {
			is.saveImageAsJpgEx("D:/nbdaily/img/2015/2/14250134175881.jpg", "d:/temp.jpg", 100, 100);
	 ...
	 *  按照给出的高宽压缩
	 */
	public boolean saveImageAsJpgEx(String fromFileStr, String saveToFileStr, int formatWideth, int formatHeight) throws Exception {
		BufferedImage srcImage;
		File saveFile = new File(saveToFileStr);
		File fromFile = new File(fromFileStr);
		srcImage = javax.imageio.ImageIO.read(fromFile); // construct image
    ...
    public String cutCenterImage(String src,String dest,int w,int h) throws IOException{   
        ...
        int width  = reader.getWidth(imageIndex)-w>0?reader.getWidth(imageIndex)-w:0;
        int height = reader.getHeight(imageIndex)-h>0?reader.getHeight(imageIndex)-h:0;
        Rectangle rect = new Rectangle(width/2, height/2, w, h);  
